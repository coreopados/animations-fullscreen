...
gulp.task('pug', function buildHTML() {
  return gulp.src('www/components/pages/*.pug')
    .pipe(pug({
      pretty: true
    }))
    .pipe(gulp.dest('www'))
...
gulp.task('watch', function () {
  gulp.watch('www/components/**/*.pug', gulp.parallel('pug'));
...
gulp.task('default', gulp.parallel('pug', 'scss', 'scriptrel', 'browser-sync', 'watch'));
